    ...
    for img in imgList:
        ...
        if lips:
            ...
            for lip in lips:
                ...
                croppedImage.save("/media/deepthi/01CE146C58D7E350/home/faces-master/pyfaces/PyFaces/testdata/word/""mouth"+str(h)+".jpg")
                h=h+1
	    #os.system("""mogrify -resize 73x50^ \ -gravity center -extent 73x50 /home/hduser/MAIN\ PROJECT/CODE/main/testdata/word/* """)
	    os.system("""mogrify -resize 3000@ /media/deepthi/01CE146C58D7E350/home/faces-master/pyfaces/PyFaces/testdata/word/* """)
        if n==1:
	    break
